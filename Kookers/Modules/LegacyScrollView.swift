...
struct RefreshView: View {
    ...
    var body: some View {
        ZStack{
            ...
            ActivityIndicator_(isAnimating: .constant(true), style: .large)
...
struct ActivityIndicator_: UIViewRepresentable {

    @Binding var isAnimating: Bool
    let style: UIActivityIndicatorView.Style

    func makeUIView(context: UIViewRepresentableContext<ActivityIndicator_>) -> UIActivityIndicatorView {
        return UIActivityIndicatorView(style: style)
    }

    func updateUIView(_ uiView: UIActivityIndicatorView, context: UIViewRepresentableContext<ActivityIndicator_>) {
